...
juegos están se encuentran en plataformas externas, lo que puede generar dificultad de uso y peligro en cuanto a seguridad digital.
...
interfaz y mezcla de distintos contenidos accesibles. Para una persona mayor, eso convierte
...
\emph{ConectaMayor} no busca reemplazar a estas herramientas, sino coger lo mejor de cada una y juntarlo en una mismo sistema.\emph{ConectaMayor} es una aplicación web gratuita, adaptada a
